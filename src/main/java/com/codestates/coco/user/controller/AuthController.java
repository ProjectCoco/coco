...
import com.codestates.coco.user.domain.JwtDto;
import com.codestates.coco.user.domain.UserLoginDTO;
import com.codestates.coco.user.jwt.JwtFilter;
...
public class AuthController {
    ...
    @PostMapping("/jwt")
    public ResponseEntity<JwtDto> authorize(@RequestBody UserLoginDTO loginDto) {
